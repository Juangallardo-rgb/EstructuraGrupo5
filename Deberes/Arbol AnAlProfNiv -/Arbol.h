...
void Arbol::anchura(Nodo* Arbol){
	...
	{
		recorridoAnch(arbol->getIzquierda());
		recorridoAnch(arbol->getDerecha());
		//recorridoAnch(arbol->getDato());
		cout << arbol->getIzquierda() <<"";
		cout <<arbol->getDerecha() <<"";
	//	cout << arbol->getDato() <<"";
	}
}
