...
//Número de cambios a la izquierda.
const unsigned int s[]={7,12,17,22,7,12,17,22,7,12,17,22,7,
        12,17,22,5,9,14,20,5,9,14,20,5,9,14,20,5,9,14,20,
        4,11,16,23,4,11,16,23,4,11,16,23,4,11,16,23,6,10,
        15,21,6,10,15,21,6,10,15,21,6,10,15,21};
        
const char str16[]="0123456789abcdef";//cadena de de 16 carácteres básicos hexadecimales
...
/*
*Función de relleno 
*Después del procesamiento, se deben cumplir los bits = 448 (mod512), y bytes = 56 (modo64)
*El método de llenado es agregar un 1 primero y agregar ceros a otros bits
...
unsigned int* add(string str)
{
    ...
    for (unsigned int i=0; i <str.length(); i++)
    {
		...
		//guardar 4 caracteres de información
    }
    strByte[str.length()>>2]|=0x80<<(((str.length()%4))*8);//Agregue 1 al final y un int sin cifrar, guarda 4 caracteres de información, 
	//así que use 128, Mover a la izquierda 
    /*
...
//función para manejar caracteres hexadecimales
...
//función para aplicar el algoritmo MD5
string getMD5(string source)
{
    atemp=A;    //inicialización de las variables temporales
    btemp=B;
    ctemp=C;
    dtemp=D;
